...
if __name__ == "__main__":
    ...
    testing_folders = np.array([
                            #  ('Bladder', 'Bladder5'),
                            #  ('Bladder', 'Bladder5Liver5'),
                            #  ('Bladder', 'Bladder5Liver15'),
                            #  ('Bladder', 'Bladder5Liver5Cervix5Skin5'),
                            #  ('Bladder', 'Bladder5Prostate5'),
                            #  ('Bladder', 'Bladder5Prostate15'),
                            #  ('Bladder', 'Bladder5Prostate5Pleura5Breast5'),

                             ('Breast', 'Breast5'),
                             ('Breast', 'Breast5Esophagus5'),
                             ('Breast', 'Breast5Esophagus15'),
                             ('Breast', 'Breast5Esophagus5Pancreas5Eye5'),
                             ('Breast', 'Breast5Uterus5'),
                             ('Breast', 'Breast5Uterus15'),
                             ('Breast', 'Breast5Uterus5Lung5HeadNeck5'),

                            #  ('Colorectal', 'Colorectal5'),
                            #  ('Colorectal', 'Colorectal5Bladder5'),
                            #  ('Colorectal', 'Colorectal5Bladder15'),
                            #  ('Colorectal', 'Colorectal5Bladder5Prostate5Eye5'),
                            #  ('Colorectal', 'Colorectal5Testis5'),
                            #  ('Colorectal', 'Colorectal5Testis15'),
                            #  ('Colorectal', 'Colorectal5Testis5BileDuct5LymphNodes5'),

                             ('Esophagus', 'Esophagus5'),
                             ('Esophagus', 'Esophagus5AdrenalGland5'),
                             ('Esophagus', 'Esophagus5AdrenalGland15'),
                             ('Esophagus', 'Esophagus5AdrenalGland5Breast5Lung5'),
                             ('Esophagus', 'Esophagus5Prostate5'),
                             ('Esophagus', 'Esophagus5Prostate15'),
                             ('Esophagus', 'Esophagus5Prostate5AdrenalGland5HeadNeck5'),

                             ('Ovary', 'Ovary5'),
                             ('Ovary', 'Ovary5Breast5'),
                             ('Ovary', 'Ovary5Breast15'),
                             ('Ovary', 'Ovary5Breast5HeadNeck5Thyroid5'),
                             ('Ovary', 'Ovary5SoftTissue5'),
                             ('Ovary', 'Ovary5SoftTissue15'),
                             ('Ovary', 'Ovary5SoftTissue5Lung5Testis5')
                        ])
    template_pool = [None, ['.tif', '.png', '.jpg'], None, modelroot, 'multicontex' ,'best_weights.pth',  True, True]
    ...
    for this_foldername, trainingset in testing_folders:
        ...
        #if args.indvidual:
        this_pool[2] = trainingset
        this_pool[3] = os.path.join(modelroot, this_foldername)

...
ModelNames = ['Bladder5', 'Bladder5Prostate5', 'Bladder5Prostate15', 'Bladder5Prostate5Pleura5Breast5', 'Bladder5Liver5',
...
plt.title('Comparison of different models on Bladder', fontsize=16, fontweight='bold')
plt.show()

...
ModelNames = ['CervixBase', 'CervixLiver5', 'CervixLiver15', 'Cervix3Extra', 'Cervix', 'All']
...
fig, ax = plt.subplots()
# line0, = ax.plot(pr_dict['Base']['recall'], pr_dict['Base']['precision'], linewidth=2, color='#369ead', label='Dashes set retroactively')
# line1, = ax.plot(pr_dict['BaseExtra5']['recall'], pr_dict['BaseExtra5']['precision'], linewidth=2, color='#c24642', label='Dashes set proactively')
# line2, = ax.plot(pr_dict['BaseExtra15']['recall'], pr_dict['BaseExtra15']['precision'], linewidth=2, color='#7f6084', label='Dashes set retroactively')
# line3, = ax.plot(pr_dict['BaseExtra35']['recall'], pr_dict['BaseExtra35']['precision'], linewidth=2, color='#86b402', label='Dashes set proactively')
# line4, = ax.plot(pr_dict['Indivisual']['recall'], pr_dict['Indivisual']['precision'], linewidth=2, color='#a2d1c5', label='Dashes set retroactively')
# line5, = ax.plot(pr_dict['Generic']['recall'], pr_dict['Generic']['precision'], linewidth=2, color='#c8b631', label='Dashes set proactively')

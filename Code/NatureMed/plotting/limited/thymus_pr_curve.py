...
line1, = ax.plot(pr_dict['BaseExtra5']['recall'], pr_dict['BaseExtra5']['precision'], linewidth=3, color='#99f052', label='Base5+1Extra5')
line2, = ax.plot(pr_dict['BaseExtra15']['recall'], pr_dict['BaseExtra15']['precision'], linewidth=3, color='#5f5f5f', label='Base5+1Extra15')
...
plt.title('Comparison of different models on Thymus', fontsize=16, fontweight='bold')
plt.show()
